...
function linearRegression(bandname) {
  ...
  var output = surfaceReflectance.expression(
    "((surfaceReflectance * (cosZenith + cvalue)) / (ic + cvalue))", {
...
Map.addLayer(surfaceReflectanceClip, vizParams, "Image before correction");
Map.addLayer(correctedImage, vizParams, "Image after correction");
